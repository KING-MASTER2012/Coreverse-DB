...
export const TeamMemberActionResponse = zod.object({
  "ok": zod.boolean()
...
export const RequestToJoinTeamResponse = zod.object({
  "id": zod.uuid(),
  "team_id": zod.uuid(),
  "user_id": zod.uuid(),
...
}).describe('A pending, accepted, rejected, or cancelled team membership action. type=join_request: user_id requested to join, an owner\/admin decides. type=invite: an owner\/admin invited user_id, who decides. type=ownership_transfer: the owner offered ownership to user_id, who decides.\n')
...
export const OfferOwnershipTransferResponse = zod.object({
  "id": zod.uuid(),
  "team_id": zod.uuid(),
  "user_id": zod.uuid(),
  "type": zod.enum(['join_request', 'invite', 'ownership_transfer']),
