 ...
 */
export const getMyProfile = async ( options?: Parameters<typeof coreverseFetch>[1]): Promise<getMyProfileResponse> => {
...
export type updateMyProfileResponseError = (updateMyProfileResponse400 | updateMyProfileResponse401 | updateMyProfileResponse404) & {
  headers: Headers;
};
 ...
 */
export const updateMyProfile = async (updateMyProfileBody: UpdateMyProfileBody, options?: Parameters<typeof coreverseFetch>[1]): Promise<updateMyProfileResponse> => {
